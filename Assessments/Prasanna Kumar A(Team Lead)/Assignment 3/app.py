...
COS_API_KEY_ID="Zh6QC1T--5Qr9ko7We3zs2_U4reygtLCAfT-FraiHpyt"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/7f9922a7d3c844e9b837382a646f06ae:68e7e326-d4db-4f75-a4a0-5d3d9dc4542f::"
...
@app.route('/')
def index():
    files = get_bucket_contents('myflask')
